...
interface IGLXGame {
    ...
    // 初始化
    function initialize(address _router, address _extToken, uint _startBlockNumber, uint _endBlockNumber, bool _isOnChainGame, address _gameObjectToken,uint256 _gameObjectTokenSupply)  external override;
    ...
    function updateGameResult() external override returns (bool);

    //当对赌的标的 是链下数据，需要oracle喂结果;防止缺省值影响，2代表true正方赢， 1代表false 反方赢，
    function updateGameResultByOracle(uint8 _gameResult) external override returns (bool);
